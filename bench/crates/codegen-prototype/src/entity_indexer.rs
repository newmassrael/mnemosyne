...
pub fn emit_rust(spec: &GraphSpec) -> EmittedRust {
    ...
    out.push_str(
        "// input source: Forge AST stub. Phase -1A stage 2C carry — 24 B BE composite key.\n",
    );
    out.push('\n');
...
pub fn emit_kotlin(spec: &GraphSpec) -> String {
    let mut out = String::new();
    out.push_str(
        "// Auto-generated by codegen-prototype (Round 52, §39 entity-indexer Kotlin emit).\n",
    );
...
pub fn emit_python(spec: &GraphSpec) -> String {
    let mut out = String::new();
    out.push_str(
        "# Auto-generated by codegen-prototype (Round 52, §39 entity-indexer Python emit).\n",
    );
...
pub fn emit_cpp(spec: &GraphSpec) -> String {
    let mut out = String::new();
    out.push_str(
        "// Auto-generated by codegen-prototype (Round 52, §39 entity-indexer C++ emit).\n",
    );
...
pub fn emit_protobuf(spec: &GraphSpec) -> String {
    let mut out = String::new();
    out.push_str(
        "// Auto-generated by codegen-prototype (Round 52, §39 entity-indexer protobuf emit).\n",
    );
...
mod tests {
    ...
    fn emit_rust_deterministic() {
        ...
        assert_eq!(
            a, b,
            "emit_rust - deterministic — identical input → byte-identical"
        );
    }
    ...
    fn design_doc_fixture_emits_all_kinds() {
        ...
        assert!(emitted
            .source
            .contains("BigEndian::write_u64(&mut buf[0..8]"));
        assert!(emitted
            .source
            .contains("BigEndian::write_u64(&mut buf[8..16]"));
        assert!(emitted
            .source
            .contains("BigEndian::write_u64(&mut buf[16..24]"));
    }
