...
pub fn emit_salsa_wire(
    ...
    out.push_str(
        "// cascade_query scope partial break audit trail (Studio Kotlin / CLI Python of\n",
    );
    ...
    out.push_str(
        "// Forge AST export consumer path read-only visualization (Round 36 out-of-paradigm)\n",
    );
...
fn emit_tracked_function(out: &mut String, query: &CascadeQuerySpec, _layout: &CfLayout) {
    ...
    out.push_str(&format!(
        "/// Cascade query `{}` — output {}.\n",
        query.name, query.output
    ));
    out.push_str(&format!(
        "/// Ordering: {} (§39 CascadeOrdering axis).\n",
        query.ordering
    ));
...
fn emit_cascade_metadata_rust(
    ...
    let mut out = String::new();
    out.push_str(
        "// Auto-generated by codegen-prototype (Round 54, §43 cascade metadata Rust emit).\n",
    );
...
fn emit_cascade_metadata_kotlin(
    ...
    let mut out = String::new();
    out.push_str(
        "// Auto-generated by codegen-prototype (Round 54, §43 cascade metadata Kotlin emit).\n",
    );
    out.push_str(
        "// Studio cascade preview affected_asset_count output source — read-only metadata.\n",
    );
    out.push('\n');
...
fn emit_cascade_metadata_python(
    ...
    let mut out = String::new();
    out.push_str(
        "# Auto-generated by codegen-prototype (Round 54, §43 cascade metadata Python emit).\n",
    );
    out.push_str(
        "# CLI cascade preview affected_asset_count output source — read-only metadata.\n",
    );
    out.push('\n');
...
fn emit_cascade_metadata_cpp(edges: &[(String, String)], orderings: &[(String, String)]) -> String {
    let mut out = String::new();
    out.push_str(
        "// Auto-generated by codegen-prototype (Round 54, §43 cascade metadata C++ emit).\n",
    );
    out.push_str(
        "// Runtime SDK cascade preview affected_asset_count output source — read-only metadata.\n",
    );
    out.push('\n');
...
fn emit_cascade_metadata_protobuf(
    ...
    let mut out = String::new();
    out.push_str(
        "// Auto-generated by codegen-prototype (Round 54, §43 cascade metadata protobuf emit).\n",
    );
    out.push_str(
        "// Wire format spec — runtime AST consumer cascade dependency graph expression.\n",
    );
    out.push('\n');
    ...
    out.push_str(
        "// ─── Fixture snapshot (auto-generated, comment only — wire data - separate) ──\n",
    );
    for (q, dep) in edges {
        out.push_str(&format!(
            "// edge: {{ query_name: \"{}\", dep_entity: \"{}\" }}\n",
            q, dep
        ));
    }
    for (q, ord) in orderings {
        out.push_str(&format!(
            "// ordering: {{ query_name: \"{}\", ordering: \"{}\" }}\n",
            q, ord
        ));
    }
    out
...
pub fn cascade_metadata_canonical_set(
    spec: &CascadeWireSpec,
...
mod tests {
    ...
    fn database_trait_emits_method_per_query() {
        ...
        assert!(emitted
            .source
            .contains("fn section_decision_status(&self, branch: CascadeBranch)"));
        assert!(emitted
            .source
            .contains("fn frozen_list_membership(&self, branch: CascadeBranch)"));
