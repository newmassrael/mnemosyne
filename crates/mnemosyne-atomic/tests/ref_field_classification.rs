...
const CLASSIFIED: &[(&str, &str, Coverage, &str)] = &[
    ...
    ("AtomicSection", "resolved_by", Coverage::Projection, "SectionId (R847), projected as a cross-ref"),
    ...
    ("InventoryEntry", "section_ref", Coverage::WritePathOnly, "SectionId (R847); no re-check found"),
