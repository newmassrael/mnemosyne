...
const CLASSIFIED: &[(&str, &str, Coverage, &str)] = &[
    ...
    ("LadderRung", "object", Coverage::Detector, "entity ref - ladder_ref_violations (R833)"),
    ...
    ("ScenePresence", "entity", Coverage::WritePathOnly, "entity ref; no re-check found"),
    ("SectionLadder", "carrier", Coverage::Detector, "entity ref - ladder_ref_violations (R833)"),
