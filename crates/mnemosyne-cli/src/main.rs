...
static COMMANDS: &[Command] = &[
    ...
    Command {
        ...
        group: Some(&GROUP_ATOMIC_MUTATE),
        blank_before: false,
        usage: &["add-predicate --predicate <id> --object-kind entity|scalar|token|quantity [--subject-kind <entity_kind>] [--object-entity-kind <entity_kind>] [--object-tokens a,b,c] [--description <text>] [--sidecar <path>] [--json]"],
    ...
    Command {
        ...
        group: Some(&GROUP_ATOMIC_MUTATE),
        blank_before: false,
        usage: &["set-predicate --predicate <id> --object-kind entity|scalar|token|quantity [--subject-kind <entity_kind>] [--object-entity-kind <entity_kind>] [--object-tokens a,b,c] --description <text> [--sidecar <path>] [--json]"],
