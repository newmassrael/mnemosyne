...
fn self_application_style_baseline_via_generic_loader() {
    ...
    assert_eq!(
        warn, 390,
        "T3 warn drift (Round 251 GENERATED.md baseline 390)"
    );
    assert_eq!(
        info, 96,
        "T4 info drift (Round 251 GENERATED.md baseline 96)"
    );
}
